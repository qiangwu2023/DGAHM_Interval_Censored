...
# spline basis config
m = 4 # number of interior knots of integrated spline basis
nodevec = np.array(np.linspace(0, 210, m + 2), dtype="float32")
...
for i in range(len(Set_n)):
    ...
    results = Parallel(n_jobs=5, backend="loky", verbose=0)(
