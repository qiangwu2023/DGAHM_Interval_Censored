...
ax1_1_Survival.set_title("Case 2, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax1_2_Survival.set_title("Case 2, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax2_1_Survival.set_title("Case 2, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax2_2_Survival.set_title("Case 2, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax3_1_Survival.set_title("Case 2, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax3_2_Survival.set_title("Case 2, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax4_1_Survival.set_title("Case 2, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax4_2_Survival.set_title("Case 2, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
#%% -----------Save all results------------
# ================Figures======================
fig1_Survival.savefig('fig_Survival_Z0_X1_case2.jpeg', dpi=400, bbox_inches='tight')
fig2_Survival.savefig('fig_Survival_Z1_X1_case2.jpeg', dpi=400, bbox_inches='tight')
fig3_Survival.savefig('fig_Survival_Z0_X2_case2.jpeg', dpi=400, bbox_inches='tight')
fig4_Survival.savefig('fig_Survival_Z1_X2_case2.jpeg', dpi=400, bbox_inches='tight')
...
result_error_beta.to_csv('beta_error_case2.csv')
# results for beta
...
result_error_gamma.to_csv('gamma_error_case2.csv')
# results for g1
...
result_re_g1.to_csv('Re_g1_case2.csv')
# results for g2
...
result_re_g2.to_csv('Re_g2_case2.csv')
