...
n_epoch = 200 
Set_lr = np.array([4e-4, 3e-4]) 
theta0 = np.array([2, 1], dtype="float32") 

beta_node_D = np.array([52, 46]) 
beta_lr_D = np.array([2e-4, 2e-4]) 
gamma_node_D = np.array([41, 31])
gamma_lr_D = np.array([2e-5, 2e-5]) 

beta_node_A = np.array([50, 50]) 
beta_lr_A = np.array([3e-4, 3e-4]) 
gamma_node_A = np.array([40, 40]) 
gamma_lr_A = np.array([1e-5, 1e-5]) 

beta_node_L = np.array([50, 50]) 
beta_lr_L = np.array([3e-4, 3e-4]) 
...
ax1_1_Survival.set_title("Case 3, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax1_2_Survival.set_title("Case 3, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax2_1_Survival.set_title("Case 3, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax2_2_Survival.set_title("Case 3, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax3_1_Survival.set_title("Case 3, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax3_2_Survival.set_title("Case 3, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax4_1_Survival.set_title("Case 3, n=500, $\Lambda_0(t)=t/8$", fontsize=10) 
...
ax4_2_Survival.set_title("Case 3, n=1000, $\Lambda_0(t)=t/8$", fontsize=10) 
...
for i in range(len(Set_n)):
    ...
    for b in range(B):
        ...
        if (i == 0):
            theta_initial = np.array([1.9, 0.9], dtype="float32") 
        else:
...
#%% -----------Save all results------------
# ================Figures======================
fig1_Survival.savefig('fig_Survival_Z0_X1_case3.jpeg', dpi=400, bbox_inches='tight')
fig2_Survival.savefig('fig_Survival_Z1_X1_case3.jpeg', dpi=400, bbox_inches='tight')
fig3_Survival.savefig('fig_Survival_Z0_X2_case3.jpeg', dpi=400, bbox_inches='tight')
fig4_Survival.savefig('fig_Survival_Z1_X2_case3.jpeg', dpi=400, bbox_inches='tight')
# =================Tables=======================
# results for beta
...
result_error_beta.to_csv('beta_error_case3.csv')
# results for beta
...
result_error_gamma.to_csv('gamma_error_case3.csv')
# results for g1
...
result_re_g1.to_csv('Re_g1_case3.csv')
# results for g2
...
result_re_g2.to_csv('Re_g2_case3.csv')
