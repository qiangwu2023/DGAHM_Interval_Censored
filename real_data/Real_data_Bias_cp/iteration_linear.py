...
def Est_linear(Z_train,X_train,U_train,V_train,De1_train,De2_train,De3_train,X_sort1,X_sort0,theta_initial,nodevec,m,C):
    C_index = 0
    d = Z_train.shape[1]
    for loop in range(100):
        print('linear_iteration time=', loop)
        g_X = g_L(Z_train,X_train,U_train,V_train,De1_train,De2_train,De3_train,X_sort1,X_sort0,theta_initial,C,m,nodevec)
        g_train = g_X['g_train']
